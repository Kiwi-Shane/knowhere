"""Build the remediated V3 bounded-synthetic retrieval report."""
...
FIXTURE_ROOT = (
    ...
    / "qualification"
    / "fixtures"
    / "v3_production_structure_remediation"
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = run_v3_production_remediation_structure_synthetic_qualification(
        fixture_set=fixture,
    ...
    if report["technical_completion"] != "qualified":
        raise RuntimeError("remediated V3 retrieval qualification failed")
